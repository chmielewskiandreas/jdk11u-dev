 ...
 *          Reference.get() works as expected. Disable the intrinsic
 *          implementation to force use of the native method.
 * @library /test/lib
 * @modules java.base/java.lang.ref:open
 * @build sun.hotspot.WhiteBox sun.hotspot.parser.DiagnosticCommand
 * @run driver ClassFileInstaller sun.hotspot.WhiteBox sun.hotspot.parser.DiagnosticCommand
 * @run main/othervm
 *    -Xbootclasspath/a:.
...
public final class TestNativeReferenceGet {
    ...
    // JDK 11 compatibility shims

    private static boolean waitForReferenceProcessing() {
        try {
            Method m = Reference.class.getDeclaredMethod("waitForReferenceProcessing");
